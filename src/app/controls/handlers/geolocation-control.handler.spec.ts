...
describe('GeolocationControlHandler', () => {
  let handler: GeolocationControlHandler;
  ...
  beforeEach(() => {
    ...
    handler = TestBed.inject(GeolocationControlHandler);
  ...
  describe('controlIdentifier', () => {
    it('should have correct control identifier', () => {
      expect(handler.controlIdentifier).toBe('sitna.geolocation');
    });
  });

  describe('sitnaConfigKey', () => {
    it('should have correct config key', () => {
      expect(handler.sitnaConfigKey).toBe('geolocation');
    });
  });
  ...
  describe('buildConfiguration()', () => {
    ...
    it('should allow parameters to override div', () => {
      ...
      expect(config?.div).toBe('custom-geolocation-div');
      expect(mockUIStateService.enableToolsButton).toHaveBeenCalled();
    });
