...
import { LocalizerControlHandler } from '../localizer/localizer-control.handler';
...
export { LocalizerControlHandler } from '../localizer/localizer-control.handler';
