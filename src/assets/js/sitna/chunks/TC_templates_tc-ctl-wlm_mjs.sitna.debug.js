"use strict";
(self["webpackChunkSITNA"] = self["webpackChunkSITNA"] || []).push([["TC_templates_tc-ctl-wlm_mjs"],{

/***/ "./TC/templates/tc-ctl-wlm.mjs":
/*!*************************************!*\
  !*** ./TC/templates/tc-ctl-wlm.mjs ***!
  \*************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({"1":function(container,depth0,helpers,partials,data) {
  ...
  return ((stack1 = container.invokePartial(lookupProperty(partials,"tc-ctl-wlm-elm"),depth0,{"name":"tc-ctl-wlm-elm","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
  ...
  return "<h2>"
    ...
    + "<span class=\"tc-ctl-wlm-n\"></span><button type=\"button\" class=\"tc-ctl-wlm-del-all tc-hidden\" title=\""
    + alias2(lookupProperty(helpers,"i18n").call(alias1,"removeAllLayersFromMap",{"name":"i18n","hash":{},"data":data,"loc":{"start":{"line":1,"column":127},"end":{"line":1,"column":160}}}))
    + "\"></button></h2>\r\n<div class=\"tc-ctl-wlm-empty\">"
...
//# sourceMappingURL=../maps/chunks/TC_templates_tc-ctl-wlm_mjs.sitna.debug.js.map