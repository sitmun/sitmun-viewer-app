"use strict";
(self["webpackChunkSITNA"] = self["webpackChunkSITNA"] || []).push([["TC_tool_ElevationServiceIDENA_js"],{
...
/* harmony import */ var _Consts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../Consts */ "./TC/Consts.js");




class ElevationServiceIDENA extends _ElevationService__WEBPACK_IMPORTED_MODULE_1__["default"] {
    constructor() {
        super(...arguments);
        const self = this;
    ...
    request(options) {
        ...
        const geometryOptions = {
            ...
            type: _Consts__WEBPACK_IMPORTED_MODULE_2__["default"].geom.POLYLINE
        };
        if (options.coordinates.length === 1) {
            geometryOptions.coordinates = options.coordinates[0];
            geometryOptions.type = _Consts__WEBPACK_IMPORTED_MODULE_2__["default"].geom.POINT;
        }
        ...
        const dataInputs = {
            ...
            geometry: {
                mimeType: _Consts__WEBPACK_IMPORTED_MODULE_2__["default"].mimeType.JSON,
                value: _TC__WEBPACK_IMPORTED_MODULE_0__["default"].wrap.Geometry.toGeoJSON(geometryOptions)
            }
        };
        if (options.crs) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ElevationServiceIDENA);

/***/ })

}]);
//# sourceMappingURL=../maps/chunks/TC_tool_ElevationServiceIDENA_js.sitna.debug.js.map