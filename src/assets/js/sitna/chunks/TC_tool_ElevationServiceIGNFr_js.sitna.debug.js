"use strict";
(self["webpackChunkSITNA"] = self["webpackChunkSITNA"] || []).push([["TC_tool_ElevationServiceIGNFr_js"],{
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _ElevationService__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ElevationService */ "./TC/tool/ElevationService.js");
/* harmony import */ var _Util__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Util */ "./TC/Util.js");



class ElevationServiceIGNFr extends _ElevationService__WEBPACK_IMPORTED_MODULE_0__["default"] {
    constructor() {
        super(...arguments);
        const self = this;
    ...
    request(options) {
        ...
        if (options.crs && options.crs !== self.nativeCRS) {
            coordinateList = _Util__WEBPACK_IMPORTED_MODULE_1__["default"].reproject(coordinateList, options.crs, self.nativeCRS);
        }
        const dataInputs = {
    ...
    parseResponse(response, options) {
        ...
        if (response.elevations) {
            ...
            if (options.crs && options.crs !== self.nativeCRS) {
                elevations = _Util__WEBPACK_IMPORTED_MODULE_1__["default"].reproject(elevations, self.nativeCRS, options.crs);
            }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ElevationServiceIGNFr);

/***/ })

}]);
//# sourceMappingURL=../maps/chunks/TC_tool_ElevationServiceIGNFr_js.sitna.debug.js.map