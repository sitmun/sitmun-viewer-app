...
/* harmony import */ var _Cfg__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../Cfg */ "./TC/Cfg.js");
/* harmony import */ var _Control__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../Control */ "./TC/Control.js");
/* harmony import */ var _infoShare__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./infoShare */ "./TC/control/infoShare.js");
/* harmony import */ var _filter__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../filter */ "./TC/filter.js");
/* harmony import */ var _ui_autocomplete__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../ui/autocomplete */ "./TC/ui/autocomplete.js");
...
_TC__WEBPACK_IMPORTED_MODULE_0__["default"].control = _TC__WEBPACK_IMPORTED_MODULE_0__["default"].control || {};
_TC__WEBPACK_IMPORTED_MODULE_0__["default"].filter = _filter__WEBPACK_IMPORTED_MODULE_5__["default"];
_TC__WEBPACK_IMPORTED_MODULE_0__["default"].UI = _TC__WEBPACK_IMPORTED_MODULE_0__["default"].UI || {};
_TC__WEBPACK_IMPORTED_MODULE_0__["default"].UI.autocomplete = _ui_autocomplete__WEBPACK_IMPORTED_MODULE_6__["default"];
_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Defaults = _Cfg__WEBPACK_IMPORTED_MODULE_2__.Defaults;
_TC__WEBPACK_IMPORTED_MODULE_0__["default"].control.infoShare = _infoShare__WEBPACK_IMPORTED_MODULE_4__["default"];
_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Control = _Control__WEBPACK_IMPORTED_MODULE_3__["default"];
_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts = _Consts__WEBPACK_IMPORTED_MODULE_1__["default"];
...
const SearchType = function (type, options, parent) {
    ...
    _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Util.extend(self, options);
    ...
    self.parseFeatures = function (data) {
        var parser;
        if (self.outputFormat === _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.format.JSON) {
            parser = new _TC__WEBPACK_IMPORTED_MODULE_0__["default"].wrap.parser.JSON();
        }
        else {
            parser = new _TC__WEBPACK_IMPORTED_MODULE_0__["default"].wrap.parser.WFS({
    ...
    self.filter = (function (self) {
        ...
        return {
            ...
            getFilter: function (data) {
                ...
                switch (true) {
                    case self.typeName === _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.NUMBER:
                        _f = [];
                        ...
                        break;
                    case self.typeName === _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.STREET:
                        _f = [];
                        ...
                        r.f = '<ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">' + '<ogc:And>' + _f.join('') + '</ogc:And>' + '</ogc:Filter>';
                        break;
                    case self.typeName === _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.LOCALITY:
            ...
            getParams: function (data) {
                ...
                return _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Util.getParamString(params);
            },
            ...
            transformFilter: function (properties) {
                ...
                if (!_TC__WEBPACK_IMPORTED_MODULE_0__["default"].filter) {
                    _TC__WEBPACK_IMPORTED_MODULE_0__["default"].syncLoadJS(_TC__WEBPACK_IMPORTED_MODULE_0__["default"].apiLocation + 'TC/Filter');
                }
                ...
                if (properties && properties instanceof Array) {
                    var filters = properties.map(function (elm) {
                        if (elm.hasOwnProperty("type")) {
                            switch (true) {
                                case elm.type === _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.comparison.EQUAL_TO: {
                                    return new _TC__WEBPACK_IMPORTED_MODULE_0__["default"].filter.equalTo(elm.name, elm.value);
                                }
                            }
                        } else {
                            return new _TC__WEBPACK_IMPORTED_MODULE_0__["default"].filter.equalTo(elm.name, elm.value);
                    ...
                    if (filters.length > 1) {
                        return _TC__WEBPACK_IMPORTED_MODULE_0__["default"].filter.and.apply(null, filters);
                    } else {
                        return filters[0];
                    }
                }
...
_TC__WEBPACK_IMPORTED_MODULE_0__["default"].control.Search = function () {
    var self = this;
    _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Control.apply(self, arguments);

    self._dialogDiv = _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Util.getDiv(self.options.dialogDiv);
    ...
    _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.event.TOOLSCLOSE = _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.event.TOOLSCLOSE || 'toolsclose.tc';
    ...
    self.availableSearchTypes[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.CADASTRAL] = {
        suggestionRoot: null,
        url: self.url || '//idena.navarra.es/ogc/wfs',
        version: self.version || '1.1.0',
        outputFormat: _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.format.JSON,
    ...
    self.availableSearchTypes[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.COORDINATES] = {
        ...
        suggestionListHead: function (_text) {
            return {
                label: self.availableSearchTypes[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.COORDINATES].label || self.getLocaleString('search.list.coordinates')
            };
        }
    };
    ...
    self.availableSearchTypes[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.MUNICIPALITY] = {
        root: null,
        limit: false,
        url: self.url || '//idena.navarra.es/ogc/wfs',
        version: self.version || '1.1.0',
        ...
        parser: self.getStringPattern.bind(this, [_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.MUNICIPALITY]),
    ...
    self.availableSearchTypes[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.COUNCIL] = {
        root: null,
        limit: false,
        url: self.url || '//idena.navarra.es/ogc/wfs',
        version: self.version || '1.1.0',
        ...
        searchWeight: 4,
        parser: self.getStringPattern.bind(this, [_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.COUNCIL]),
        stringPatternToCheck: self.stringPatternsValidators.s_or_t,
        goTo: self.goToStringPattern,
        idPropertiesIdentifier: '#',
        suggestionListHead: {
    ...
    self.availableSearchTypes[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.STREET] = {
        root: null,
        limit: null,
        url: self.url || '//idena.navarra.es/ogc/wfs',
        version: self.version || '1.1.0',
        ...
        parser: self.getStringPattern.bind(this, [_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.STREET]),
        goTo: self.goToStringPattern
    };

    self.availableSearchTypes[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.NUMBER] = {
        root: null,
        limit: null,
        url: self.url || '//idena.navarra.es/ogc/wfs',
        version: self.version || '1.1.0',
        ...
        parser: self.getStringPattern.bind(this, [_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.NUMBER]),
        goTo: self.goToStringPattern
    };

    self.availableSearchTypes[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.URBAN] = {
        root: null,
        limit: false,
        url: self.url || '//idena.navarra.es/ogc/wfs',
        version: self.version || '1.1.0',
        ...
        parser: self.getStringPattern.bind(this, [_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.URBAN]),
        stringPatternToCheck: self.stringPatternsValidators.s_or_t,
        goTo: self.goToStringPattern
    };

    self.availableSearchTypes[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.PLACENAME] = {
        root: null,
        limit: false,
        url: self.url || '//idena.navarra.es/ogc/wfs',
        version: self.version || '1.1.0',
        ...
        parser: self.getStringPattern.bind(this, [_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.PLACENAME]),
        stringPatternToCheck: self.stringPatternsValidators.s_or_t,
        goTo: self.goToStringPattern
    };

    self.availableSearchTypes[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.PLACENAMEMUNICIPALITY] = {
        root: null,
        limit: false,
        url: self.url || '//idena.navarra.es/ogc/wfs',
        version: self.version || '1.1.0',
        ...
        parser: self.getStringPattern.bind(this, [_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.PLACENAMEMUNICIPALITY]),
        stringPatternToCheck: [self.stringPatternsValidators.ts, self.stringPatternsValidators.st],
        goTo: self.goToStringPattern
    };

    self.availableSearchTypes[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.COMMONWEALTH] = {
        root: null,
        limit: false,
        url: self.url || '//idena.navarra.es/ogc/wfs',
        version: self.version || '1.1.0',
    ...
    self.availableSearchTypes[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.ROAD] = {
        root: null,
        limit: false,
        url: self.url || '//idena.navarra.es/ogc/wfs',
        version: self.version || '1.1.0',
    ...
    self.availableSearchTypes[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.ROADMILESTONE] = {
        root: null,
        limit: false,
        url: self.url || '//idena.navarra.es/ogc/wfs',
        version: self.version || '1.1.0',
    ...
    self.rootCfg = {};
    self.rootCfg[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.MUNICIPALITY] = {
        root: null,
        limit: false,
        url: self.url || '//idena.navarra.es/ogc/wfs',
        version: self.version || '1.1.0',
        ...
        getRootLabel: function () {
            return new Promise(function (resolve, _reject) {
                ...
                if (self.rootCfg.active && !self.rootCfg[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.MUNICIPALITY].rootLabel) {

                    var params = {};
                    params.SERVICE = 'WFS';
                    params.VERSION = self.rootCfg[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.MUNICIPALITY].version;
                    params.REQUEST = 'GetFeature';
                    params.TYPENAME = self.rootCfg[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.MUNICIPALITY].featurePrefix + ':' + self.rootCfg[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.MUNICIPALITY].featureType;
                    params.OUTPUTFORMAT = self.rootCfg[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.MUNICIPALITY].outputFormat;
                    params.PROPERTYNAME = ['CMUNICIPIO'].concat(self.rootCfg[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.MUNICIPALITY].outputProperties).join(',');

                    params.CQL_FILTER = self.rootCfg[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.MUNICIPALITY].root.map(function (elem) {
                    ...
                    _TC__WEBPACK_IMPORTED_MODULE_0__["default"].ajax({
                        url: self.rootCfg[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.MUNICIPALITY].url + '?' + _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Util.getParamString(params),
                        method: 'GET',
                        responseType: _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.mimeType.JSON
                    }).then(function (response) {
                        const data = response.data;
                        if (data.totalFeatures > 0) {

                            self.rootCfg[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.MUNICIPALITY].rootLabel = data.features.map(function (feature) {
                                return {
                                    id: ['CMUNICIPIO'].map(function (elem) {
                                        return feature.properties[elem];
                                    }).join('#'),
                                    label: feature.properties[self.rootCfg[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.MUNICIPALITY].outputProperties[0]].toLowerCase()
                                };
                            });

                            resolve(self.rootCfg[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.MUNICIPALITY].rootLabel);

                        } else {
                            self.rootCfg[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.MUNICIPALITY].rootLabel = [];
                            resolve(self.rootCfg[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.MUNICIPALITY].rootLabel);
                        }
                    }).catch(function () {
                        resolve([]);
    ...
    self.rootCfg[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.LOCALITY] = {
        root: null,
        limit: false,
        url: self.url || '//idena.navarra.es/ogc/wfs',
        version: self.version || '1.1.0',
        ...
        getRootLabel: function () {
            return new Promise(function (resolve, _reject) {
                if (self.rootCfg.active && !self.rootCfg[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.LOCALITY].rootLabel) {

                    var params = {};
                    params.SERVICE = 'WFS';
                    params.VERSION = self.rootCfg[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.LOCALITY].version;
                    params.REQUEST = 'GetFeature';
                    params.TYPENAME = self.rootCfg[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.LOCALITY].featurePrefix + ':' + self.rootCfg[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.LOCALITY].featureType;
                    params.OUTPUTFORMAT = self.rootCfg[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.LOCALITY].outputFormat;
                    params.PROPERTYNAME = ['CMUNICIPIO', 'CENTIDAD'].concat(self.rootCfg[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.LOCALITY].outputProperties).join(',');

                    params.CQL_FILTER = self.rootCfg[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.LOCALITY].root.map(function (elem) {
                    ...
                    _TC__WEBPACK_IMPORTED_MODULE_0__["default"].ajax({
                        url: self.rootCfg[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.LOCALITY].url + '?' + _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Util.getParamString(params),
                        method: 'GET',
                        responseType: _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.mimeType.JSON
                    }).then(function (response) {
                        const data = response.data;
                        if (data.totalFeatures > 0) {
                            ...
                            self.rootCfg[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.LOCALITY].rootLabel = data.features.map(function (feature) {
                                return {
                                    id: ['CMUNICIPIO', 'CENTIDAD'].map(function (elem) {
                                        return feature.properties[elem];
                                    }).join('#'),
                                    label: feature.properties[self.rootCfg[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.LOCALITY].outputProperties[0]].toLowerCase()
                                };
                            });

                            resolve(self.rootCfg[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.LOCALITY].rootLabel);

                        } else {
                            self.rootCfg[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.LOCALITY].rootLabel = [];
                            resolve(self.rootCfg[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.LOCALITY].rootLabel);
                        }
                    }).catch(function () {
                        resolve([]);
    ...
    if (self.options.allowedSearchTypes) {
        for (var allowed in self.options.allowedSearchTypes) {
            ...
            if (self.availableSearchTypes[allowed] && !_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Util.isEmptyObject(self.options.allowedSearchTypes[allowed])) {
                ...
                _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Util.extend(self.availableSearchTypes[allowed], self.options.allowedSearchTypes[allowed]);
                ...
                if (self.options.allowedSearchTypes[allowed].root &&
                    (allowed !== _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.MUNICIPALITY && self.options.allowedSearchTypes[allowed].rootType === _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.MUNICIPALITY) ||
                    allowed !== _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.LOCALITY && self.options.allowedSearchTypes[allowed].rootType === _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.LOCALITY) {
                    ...
                    self.availableSearchTypes[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.STREET].queryProperties.firstQueryWord =
                        self.availableSearchTypes[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.NUMBER].queryProperties.firstQueryWord =
    ...
    self.wrap = new _TC__WEBPACK_IMPORTED_MODULE_0__["default"].wrap.control.Search(self);
    ...
    if (silmeSearch == null)//Silme
        silmeSearch = self;//Silme
};

_TC__WEBPACK_IMPORTED_MODULE_0__["default"].inherit(_TC__WEBPACK_IMPORTED_MODULE_0__["default"].control.Search, _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Control);
_TC__WEBPACK_IMPORTED_MODULE_0__["default"].mix(_TC__WEBPACK_IMPORTED_MODULE_0__["default"].control.Search, _TC__WEBPACK_IMPORTED_MODULE_0__["default"].control.infoShare);

(function () {
    var ctlProto = _TC__WEBPACK_IMPORTED_MODULE_0__["default"].control.Search.prototype;

    ctlProto.CLASS = 'tc-ctl-search';

    _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.event.SEARCHQUERYEMPTY = _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.event.SEARCHQUERYEMPTY || 'searchqueryempty.tc';

    ctlProto.template = {};
    ctlProto.template[ctlProto.CLASS] = _TC__WEBPACK_IMPORTED_MODULE_0__["default"].apiLocation + "TC/templates/tc-ctl-search.hbs"; //Silme 
    //ctlProto.template[ctlProto.CLASS] = "templates/SearchSilme.hbs";
    ctlProto.template[ctlProto.CLASS + '-dialog'] = _TC__WEBPACK_IMPORTED_MODULE_0__["default"].apiLocation + "TC/templates/tc-ctl-search-dialog.hbs";

    ctlProto.register = function (map) {
        const self = this;
        return new Promise(function (resolve, reject) {
            Promise.all([_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Control.prototype.register.call(self, map), self.renderPromise()]).then(function () {
    ...
    const highlighting = function (elm) {
        ...
        if (elm.dataRole === _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.ROAD || elm.dataRole === _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.ROADMILESTONE) {
    ...
    const selectionCallback = function (e) {
        ...
        if (_target.querySelector('span[hidden]')) {
            ...
            _TC__WEBPACK_IMPORTED_MODULE_0__["default"].UI.autocomplete.call(self.textInput, 'clear');

            self.shareButton && self.shareButton.classList.remove(_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.classes.HIDDEN);
        }
    };
    ...
    ctlProto.renderData = function (data, callback) {
        ...
        var _search = function () {
            self.search(self.textInput.value, function (list) {
                if (list.length === 1) {
                    ...
                    self.resultsList.classList.add(_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.classes.HIDDEN);
                }
        ...
        self.layerStyleFN = (function () {
            ...
            function getStyle(property, geomType, id) {
                ...
                return _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Cfg.styles[geomType][property];
            }
            return function (geomType, property, extractValue, f) {
                var self = this;
                if (_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Feature && !(f instanceof _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Feature)) {
                    self.map.trigger(_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.event.FEATURESADD, { layer: self.layer, geom: f.geom });
                }
        ...
        return new Promise(function (resolve, reject) {
            _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Control.prototype.renderData.call(self, Object.assign(data || {}, { share: self.options.share }), function () {
                if (self.map) {
                    self.layerPromise = self.map.addLayer({
                        ...
                        stealth: true,
                        declutter: true,
                        type: _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.layerType.VECTOR,
                        styles: {
                            polygon: {
                            ...
                            marker: {
                                anchor: _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Defaults.styles.marker.anchor,
                                height: _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Defaults.styles.marker.height,
                                width: _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Defaults.styles.marker.width
                            },
                            point: {
                ...
                self.button.addEventListener(_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.event.CLICK, function () {
                ...
                self.resultsList.addEventListener(_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.event.CLICK, _TC__WEBPACK_IMPORTED_MODULE_0__["default"].EventTarget.listenerBySelector('a.' + self.CLASS + '-li-empty', function () {
                    self.resultsList.classList.add(_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.classes.HIDDEN);
                ...
                self.textInput.addEventListener("search", function () {
                    if (self.textInput.value.length === 0) {
                        delete self.toShare;
                        self.shareButton && self.shareButton.classList.add(_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.classes.HIDDEN);
                        self.resultsList.classList.add(_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.classes.HIDDEN);
                        _search();
                    }
                });
                ...
                self.textInput.addEventListener("targetUpdated.autocomplete", function () {
                    if (self.resultsList.querySelectorAll('li').length > 0) {
                        self.resultsList.classList.remove(_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.classes.HIDDEN);
                    }
                });
                ...
                if (self.options.share) {
                    ...
                    self.shareButton.addEventListener(_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.event.CLICK, function () {
                ...
                _TC__WEBPACK_IMPORTED_MODULE_0__["default"].UI.autocomplete.call(self.textInput, {
                    link: '#',
                ...
                if (_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Util.isFunction(callback)) {
                    callback();
                }
    ...
    ctlProto.cleanMap = function () {
        ...
        if (self.layer) {
            ...
            if (features && features.length > 0) {
                self.map.trigger(_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.event.FEATUREREMOVE, { layer: l, feature: features[0] });
            }
    ...
    ctlProto.getMunicipalities = function () {
        ...
        _TC__WEBPACK_IMPORTED_MODULE_0__["default"].cache.search = _TC__WEBPACK_IMPORTED_MODULE_0__["default"].cache.search || {};
        self._municipalitiesPromise = new Promise(function (resolve, _reject) {
            if (_TC__WEBPACK_IMPORTED_MODULE_0__["default"].cache.search.municipalities) {
                resolve(_TC__WEBPACK_IMPORTED_MODULE_0__["default"].cache.search.municipalities);
            }
            else {
                var type = self.getSearchTypeByRole(_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.CADASTRAL);
                ...
                if (type.municipality && type.municipality.featureType && type.municipality.labelProperty && type.municipality.idProperty) {
                    ...
                    var url = type.url + '?' + _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Util.getParamString(params);
                    _TC__WEBPACK_IMPORTED_MODULE_0__["default"].ajax({
                        url: url,
                        method: 'GET',
                        responseType: 'text'
                        ...
                        const data = response.data;
                        var parser;
                        if (type.outputFormat === _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.format.JSON) {
                            parser = new _TC__WEBPACK_IMPORTED_MODULE_0__["default"].wrap.parser.JSON();
                        }
                        else {
                            parser = new _TC__WEBPACK_IMPORTED_MODULE_0__["default"].wrap.parser.WFS({
                        ...
                        _TC__WEBPACK_IMPORTED_MODULE_0__["default"].cache.search.municipalities = [];
                        for (var i = 0; i < features.length; i++) {
                            var feature = features[i];
                            _TC__WEBPACK_IMPORTED_MODULE_0__["default"].cache.search.municipalities.push({ label: feature.data[type.municipality.labelProperty], id: feature.data[type.municipality.idProperty] });
                        }

                        _TC__WEBPACK_IMPORTED_MODULE_0__["default"].cache.search.municipalities.sort(function (a, b) {
                            var result;
                            if (a.label < b.label) {
                                result = -1;
                            }
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (/\d/.test(pattern) && (new RegExp('^([-+]?[0-9]{' + self.UTMX_LEN + '}(?:[.,]\\d+)?)\\s*\\,?\\s*([-+]?[0-9]{' + self.UTMY_LEN + '}(?:[.,]\\d+)?)$').test(pattern) || /^([-+]?\d{1,3}([.,]\d+)?)\,?\s*([-+]?\d{1,2}([.,]\d+)?)$/.test(pattern))) {
                ...
                if (!match || match && (match[1].indexOf(',') > -1 ? match[1].replace(',', '.') : match[1]) <= 180 && (match[3].indexOf(',') > -1 ? match[3].replace(',', '.') : match[3]) <= 90) {
                    ...
                    var coords = _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Util.parseCoords(pattern);
                    if (coords) {
                        var xValue = coords[0].value;
                        var yValue = coords[1].value;
                        var xLabel = coords[0].type === _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.UTM ? self.UTMX : self.LAT;
                        var yLabel = coords[1].type === _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.UTM ? self.UTMY : self.LON;
                        ...
                        if (point && !self.insideLimit(point)) {
                            ...
                            xLabel = coords[1].type === _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.UTM ? self.UTMX : self.LAT;
                            yLabel = coords[0].type === _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.UTM ? self.UTMY : self.LON;
                            id = xLabel + xValue + yLabel + yValue;
                            point = self.getPoint(id);
                        }

                        if (point) {
                            self.availableSearchTypes[_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.COORDINATES].label = /^X([-+]?\d+(?:\.\d+)?)Y([-+]?\d+(?:\.\d+)?)$/.test(id) ? self.getLocaleString('search.list.coordinates.utm') + self.map.crs : self.getLocaleString('search.list.coordinates.geo');

                            //console.log('getCoordinates promise resuelta');
                            resolve([{
                                id: id, label: self.getLabel(id), dataRole: _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.COORDINATES
                            }]);
                        }
                        else {
                            //console.log('getCoordinates promise resuelta');
    ...
    ctlProto.getCadastralRef = function (pattern) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (!/^(.*)\,(\s*\d{1,2}\s*)\,(\s*\d{1,4}\s*)$/.test(pattern) && self.getSearchTypeByRole(_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.CADASTRAL).suggestionRoot)
                _pattern = self.getSearchTypeByRole(_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.CADASTRAL).suggestionRoot + ', ' + pattern;
                    ...
                    if (match) {
                        ...
                        const getItem = function (mun, munLabel, pol, par) {
                            ...
                            return {
                                ...
                                dataRole: _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.CADASTRAL,
                        ...
                        if (/^[0-9]*$/g.test(match[1])) {
                            ...
                            if (match[1].trim() === self.getSearchTypeByRole(_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.CADASTRAL).suggestionRoot) {

                                var suggestionRoot = list.filter(function (elm) {
                                    return parseInt(elm.id) === parseInt(self.getSearchTypeByRole(_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.CADASTRAL).suggestionRoot);
                                })[0];
        ...
        if (root) {
            ...
            while (i--) {
                if (!addRoot) {
                    if (result[i].t) {
                        ...
                        if (indicatedRoot.length === 1) {
                            ...
                            indicatedRoot.map(function (elem) {
                                var newResult = _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Util.extend({
                                }, result[i]);
                                newResult.t = elem.id;
                    ...
                    result.push(_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Util.extend({}, result[i], { t: root }));
                }
            }
        }
    };
    ...
    const getObjectsFromStringToQuery = function (allowedRoles, text) {
        ...
        if (test(text)) {
            ...
            try {
                ...
                _TC__WEBPACK_IMPORTED_MODULE_0__["default"].error("Error según el patrón: " + text, _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.msgErrorMode.EMAIL, "Error en la búsqueda del callejero");
            }
        ...
        return fetch(type.url, {
            ...
            .catch(function (err) {
                if (err.name === 'AbortError') {
                    ...
                    _TC__WEBPACK_IMPORTED_MODULE_0__["default"].error(err);
                }
    ...
    ctlProto.getRoad = function (pattern) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (pattern.length < 2) {
                ...
                var type = self.getSearchTypeByRole(_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.ROAD);
    ...
    ctlProto.getMilestone = function (pattern) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (pattern.length < 3) {
                ...
                var type = self.getSearchTypeByRole(_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.searchType.ROADMILESTONE);
    ...
    ctlProto._goToResult = function (id, dataRole) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (matchMedia('(max-width: 30em)').matches) {
                self.textInput.blur();
                self.map.trigger(_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.event.TOOLSCLOSE);
            }
            ...
            if (goTo) {
                self.getLayer().then(function (layer) {
                    var i;
                    switch (true) {
                        case goTo.params.type === _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.layerType.VECTOR:
                            for (i = 0; i < self.WFS_TYPE_ATTRS.length; i++) {
                                if (layer.hasOwnProperty(self.WFS_TYPE_ATTRS[i]))
                                    delete layer[self.WFS_TYPE_ATTRS[i]];
                            }
                            break;
                        case goTo.params.type === _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.layerType.WFS:
                            for (i = 0; i < self.WFS_TYPE_ATTRS.length; i++) {
                    ...
                    const onFeaturesAdd = function (e) {
                        if (e.layer === self.layer) {
                            self.map.off(_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.event.FEATURESADD, onFeaturesAdd);
                            setQueryableFeatures.call(self, e.features);
                        }
                    };
                    self.map.on(_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.event.FEATURESADD, onFeaturesAdd);

                    const layerEventHandler = function (e) {
                        if (e.layer === layer) {
                            self.map.off(_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.event.LAYERUPDATE, layerEventHandler);
                            // Salta cuando se pinta una feature que no es de tipo API porque la gestión de estilos salta antes (no es controlable)
                            self.map.one(_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.event.FEATURESADD, function (e) {
                                if (e.layer === layer) {
                                    if (!e.layer.features || e.layer.features.length === 0 && e.layer.wrap.layer.getSource().getFeatures()) {
                                        ...
                                        self.map.trigger(_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.event.FEATURESADD, { layer: self.layer, features: self.layer.features });

                                    } else if (e.layer.features && e.layer.features.length === 0 && goTo.params.type === _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.layerType.WFS) {
                                        self.resultsList.inner = goTo.emptyResultHTML;
                                        self.textInput.dispatchEvent(new CustomEvent("targetUpdated.autocomplete"));

                                        self.map.trigger(_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.event.SEARCHQUERYEMPTY);
                                    }
                                }
                    ...
                    self.map.on(_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.event.LAYERUPDATE, layerEventHandler);
    ...
    var drawPoint = function (id) {
        ...
        if (point) {
            ...
            promise = self.layer.addMarker(point, _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Util.extend({}, self.map.options.styles.point, { title: title, group: title }));
        } else {
        ...
        promise.then(function (feat) {
            self.map.trigger(_TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.event.FEATURESADD, {
    ...
    ctlProto.goToCadastralRef = function (id) {
        ...
        if (regex.test(id)) {
            ...
            goTo.params = {
                type: _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.layerType.WFS,
                url: type.url,
                version: type.version,
                geometryName: type.geometryName,
                featurePrefix: type.featurePrefix,
                featureType: type.featureType,
                properties: new _TC__WEBPACK_IMPORTED_MODULE_0__["default"].filter.and(
                    new _TC__WEBPACK_IMPORTED_MODULE_0__["default"].filter.equalTo(type.queryProperties.firstQueryWord, match[1].trim()),
                    new _TC__WEBPACK_IMPORTED_MODULE_0__["default"].filter.equalTo(type.queryProperties.secondQueryWord, match[2].trim()),
                    new _TC__WEBPACK_IMPORTED_MODULE_0__["default"].filter.equalTo(type.queryProperties.thirdQueryWord, match[3].trim())),
                outputFormat: type.outputFormat,
                styles: type.styles
            };
    ...
    ctlProto.getPoint = function (pattern) {
        ...
        if (match && match.length === 3) {
            ...
            if (isMapGeo) {
                point = _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Util.reproject(point, self.map.options.utmCrs, self.map.crs);
            }
        }
        else {
            ...
            if (match && match.length === 3) {
                ...
                if (!isMapGeo) {
                    return _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Util.reproject(point, self.map.options.geoCrs, self.map.crs);
                }
            }
    ...
    ctlProto.getLabel = function (id) {
        var self = this;
        var result = id;
        var locale = _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Util.getMapLocale(self.map);

        const geoCoordsLabel = function (result, match) {
            let parsedCoords = _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Util.parseCoords(match[1] + ',' + match[3]);
            result = result.replace(match[1], parsedCoords[0].value.toLocaleString(locale, { minimumFractionDigits: _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.DEGREE_PRECISION, maximumFractionDigits: _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.DEGREE_PRECISION }));
            result = result.replace(match[3], parsedCoords[1].value.toLocaleString(locale, { minimumFractionDigits: _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.DEGREE_PRECISION, maximumFractionDigits: _TC__WEBPACK_IMPORTED_MODULE_0__["default"].Consts.DEGREE_PRECISION }));
...
const Search = _TC__WEBPACK_IMPORTED_MODULE_0__["default"].control.Search;
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("90c8c5f4652952c9666e")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=maps/main.018bf8dedb57e872f7e4.hot-update.js.map